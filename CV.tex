...
\begin{itemize}[parsep=0.5ex]
    ...
    \item \textbf{专业技能：} \url{https://maksymilan.github.io/}
    \begin{enumerate}[parsep=0ex, topsep=0.5ex]
        \item 熟悉 Zemax / LightTools / Code V 光学系统设计与鬼像分析
        \item 掌握 Multisim 模拟与数字电路设计及芯片分析
        \item 熟悉 Python / MATLAB 在数据处理与 FDTD 电磁场仿真中的应用
    \end{enumerate}
\end{itemize}
\end{document}
