...
% 【核心修复】只保留这一行带 [inline] 参数的 enumitem，删除重复的 \usepackage{enumitem}
...
\textbf{浙江大学\quad 光电信息科学与工程} \hfill 2024.9 -- 至今\\[0.5em] % 标题和正文间加一点距离
GPA:4.58/5.0\quad\quad\quad\quad\quad\quad专业排名：3/90
...
\begin{itemize}[label={}, leftmargin=0pt, itemindent=0pt, itemsep=0.3em]
    \item \makebox[0.2\textwidth][l]{\textbf{2026.6}}%
...
\section{\makebox[\widthof{\faUsers}][c]{\color{CVBlue}\faUsers}\ 专业技能}   
\begin{itemize}[parsep=0.5ex]
    \item \textbf{英语水平：} CET-4(638), CET-6(606), IELTS(7)
    \item \textbf{专业知识：}%
    \begin{enumerate*}[itemjoin={\\ \hspace*{5.5em}}] % 调大了缩进量，使换行后的第2点与第1点精准左对齐
