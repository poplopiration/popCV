...
光电信息科学与工程\quad 大二 
\begin{itemize}[nosep]
    \item 相关课程：《烂坑挖掘及基础1》、《高级挖坑技巧2》、《烂坑数理统计3》
\end{itemize}
...
\begin{itemize}[label={}, leftmargin=0pt, itemindent=0pt, itemsep=0.3em]
    \item \makebox[0.2\textwidth][l]{\textbf{2023.12}}%
          \makebox[0.6\textwidth][c]{\textbf{第14届“宇瞳杯”光学设计赛道}}%
          \makebox[0.2\textwidth][r]{\textbf{二等奖}}
          
    \item \makebox[0.2\textwidth][l]{\textbf{2025.11}}%
          \makebox[0.6\textwidth][c]{\textbf{全国高校商业精英挑战赛创新创业竞赛}}%
          \makebox[0.2\textwidth][r]{\textbf{国家级一等奖}}
\end{itemize}
